...
## Running
To interact with the web application, you will need to first access the `OpenCV-Python-Series-master` folder, following which the `src` folder and run the `webApp.py` file within the same. This can be found at:
```
